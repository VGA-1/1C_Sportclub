...
Процедура ПланировщикПриОкончанииРедактирования(Элемент, НовыйЭлемент, ОтменаРедактирования)
    ...
    ИзмЭл = Элемент.ВыделенныеЭлементы.Получить(0);

    ОбновитьЗаписьРасписанияНаСервере(
        ИзмЭл.Начало,
        ИзмЭл.Конец,
        ИзмЭл.ЗначенияИзмерений
    );
...
Процедура ПланировщикПриИзменении(Элемент)
	...
	Сообщить("При изменении");
	
	ИзменяемыйЭлемент = Элемент.ВыделенныеЭлементы.Получить(0);
	ДатаНачала = ИзменяемыйЭлемент.Начало;
	ДатаКонца = ИзменяемыйЭлемент.Конец;
	ЗначенияИзмерений = ИзменяемыйЭлемент.ЗначенияИзмерений;
	
	//СохранитьЭлементПланировщикаНаСервере(Элемент);
...
&НаСервере
Процедура СохранитьЭлементПланировщикаНаСервере(ДатаНачала, ДатаКонца, ЗначенияИзмерений) Экспорт
