...
&НаСервере
Функция АбонементыВидАбонементаПриИзмененииНаСервере(СсылкаАбонемент)
...
&НаКлиенте
Процедура АбонементыВидАбонементаПриИзменении(Элемент)
	СсылкаАбонемент = Элементы.Абонементы.ТекущиеДанные.ВидАбонемента;
	Данные = АбонементыВидАбонементаПриИзмененииНаСервере(СсылкаАбонемент);
